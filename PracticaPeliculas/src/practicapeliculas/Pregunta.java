...
public class Pregunta {
    ...
    int id=0, puntos_jugador_1=0, puntos_jugador_2=0, preg=0;
    //Pelicula pelicula;
    ...
    String atributos2[] = {"Año: ", "Director: ", "Género: ", "Actor: ", "Actriz: ", "Título: "};
    ...
    public int seleccionarPregunta(Usuario u, ArrayList<Pelicula> pe, String titulo, String director, String genero, String actor, String actriz, String año){
        preg++;
        if(preg == 1){
    ...
    public void cuerpoPregunta2(Usuario u, ArrayList<Pelicula> pe, String[] auxPreg, String[] auxSol, String[] auxAtr, String cero, String uno, String dos, String tres, String cuatro, String cinco){
        ...
        if(cero.equals(respuesta1)){
            ...
            if(cero.equals(respuesta2)){
                puntos_jugador_1=+puntos_jugador_1+40;
                ...
                if(cero.equals(respuesta3)){
                    puntos_jugador_1=+puntos_jugador_1+30;
                    ...
                    if(cero.equals(respuesta4)){
                        puntos_jugador_1=+puntos_jugador_1+20;
                        ...
                        if(cero.equals(respuesta5)){
                            puntos_jugador_1=+puntos_jugador_1+10;
